...
# 57697.590190464034
# 53451.99798753473
def likelihood_chart_wrapper(ipix, nside=8, Ts=nano11_Ts):
    import time
    start_time = time.time()
    outdir =  '/home/nima/nanograv/11yr_factlike/ULvSky_charts/'
    ...
    bwm_log10_As = np.linspace(-17,-10,70, endpoint=True)
